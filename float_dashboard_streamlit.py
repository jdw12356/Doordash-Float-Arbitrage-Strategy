...
st.set_page_config(page_title="Doordash Float Arbitrage", layout="wide")
st.title("Doordash Float Arbitrage Dashboard")

st.markdown("Simulate your Kalarnma Doordash float deployment and view profit, risk, and capital efficiency.")
...
df = simulate_strategy(days, daily_spend_base)
...
if simulate_google_sheets:
    st.warning("Upload your service account key JSON and add sync functionality in Colab.")
